...
type TransactionRow = { id: string; date: string; type: TransactionType; label: string; amount: number };
...
export default function Transactions() {
  ...
  }, [settlementsQuery.data, deductionsQuery.data, t, date]);
  ...
  return (
    <Screen>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'row', marginTop: spacing.sm, marginBottom: spacing.md }}>
