...
module.exports = {
  expo: {
    ...
    android: {
      ...
      versionCode: 1,
      adaptiveIcon: {
        // APP ICON + SPLASH (owner decision 2026-08-27): was the default
        // Expo template's light-blue placeholder (#E6F4FE) — replaced with
        // the app's own theme.ts colors.bg so it matches
        // android-icon-background.png (generated by
        // scripts/generateBrandAssets.js) and the in-app dark theme.
